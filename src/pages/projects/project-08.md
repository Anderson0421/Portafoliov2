...
<div class="pr-5">
<h1 class="text-2xl font-bold mb-5 text-gray-100"><span class="text-yellow-300">3er puesto</span> en concurso WeLatin@s del total de 120 equipos!</h1>
<p class="text-gray-50">
En el Perú, la falta de oportunidad laboral afecta un 75% de jóvenes. Donde el 40% tienen menos de un año de experiencia, del total, un 29% lleva entre 3 a 6 meses buscando oportunidad laboral y el 45% no encuentra por no tener expedición, después de haber culminado sus estudios de pre grado. FUENTE: RPP – 2023</p>
...
Volver 
    ...
    <div class="flex flex-col justify-center mb-20">
          <h1 class="text-2xl font-bold py-2 mt-5 text-gray-50" id="content">Inicio de sesion</h1>
          <div>
         ...
         <div class="max-2xl:w-full max-2xl:pr-5">
          ...
          <h1 class="text-2xl font-bold py-2 mt-5 text-gray-50"> Seccion de perfil</h1>
           <div>
            <p class="mb-10 w-3/4 text-gray-50">
         ...
         <div class="max-2xl:w-full max-2xl:pr-5 text-gray-50">
          <img src="../devcollab/img1.jpg" alt="img1" class="rounded-lg">
          </div>
          <h1 class="text-2xl font-bold mt-5 mb-5 text-gray-50">Gestión de tus propios proyectos y unirse a otros proyectos</h1>
           <div>
            <p class="mb-10 w-3/4 text-gray-50">
